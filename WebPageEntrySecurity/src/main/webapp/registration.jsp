...
<input type="hidden" id="status" value="<%= request.getAttribute("status") %>">
	...
	if(status == "Success"){
		swal("Well Done", "Account Created Successfully!","success");
	}
	else if(status == "invalidName"){
		swal("Sorry", "Please Enter Account Name!","error");
	}
	else if(status == "invalidUpwd"){
		swal("Sorry", "Please Enter Account Password!","error");
	}
	...
	else if(status == "invalidContactno"){
		swal("Sorry", "Please Enter Contact Number!","error");
	}
	else if(status == "invalidContactnoLength"){
